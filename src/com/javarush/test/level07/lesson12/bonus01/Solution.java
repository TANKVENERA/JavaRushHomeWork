...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            Cat cat = new Cat(name, age, weight, tailLength); // здесь в список передается целый объект типа Саt, т е
            CATS.add(cat);                                    // каждый элемент списка содержит не просто, например
            // строку, как раньше, а ссылочную переменную на объект, в которой хранится имя,
            // возраст, вес, длина хвоста
        }
